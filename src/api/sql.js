...
var Promise = require('core/promise.js');

function SQL(options) {
  // if SQL is called without new keyword, make sure the instantiation of the SQL gets done properly so we don't
  // accidentally sets variables on the local scope.
  if (global === this || (global.cartodb || {}) === this) {
